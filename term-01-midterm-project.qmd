...
Your supervisor has asked you to process and analyze this dataset using statistical and analytical packages (e.g., R, Python, Excel, or Stata) to generate insights that can inform economic policy, infrastructure investment, and early warning systems.
...
5.  🗺️ Latitude vs. Longitude Plot
